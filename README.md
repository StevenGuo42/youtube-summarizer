...
- YouTube video, channel, and playlist browsing with visibility and date range filters
...
- **Browse** -- Search channels, browse playlists, filter by visibility and date range, select videos to queue
...
| `GET /api/channel/{id}/videos` | List videos for a channel (supports filters: members_only, date range, pagination) |
